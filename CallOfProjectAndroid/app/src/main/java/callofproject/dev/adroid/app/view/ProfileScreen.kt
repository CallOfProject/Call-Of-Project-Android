...
class ProfileScreen : ComponentActivity() {
    companion object {
        ...
        private fun UserExperienceComponent(navController: NavController) {
            EditableCardComponent("Experience", 400.dp, imageVector = Icons.Filled.Add, imageDescription = "Add",
        ...
        private fun UserEducationComponent(navController: NavController) {
            EditableCardComponent("Education", 400.dp, imageVector = Icons.Filled.Add, imageDescription = "Add",
        ...
        private fun UserCoursesComponent(navController: NavController) {
            EditableCardComponent("Courses", 490.dp, imageVector = Icons.Filled.Add, imageDescription = "Add",
