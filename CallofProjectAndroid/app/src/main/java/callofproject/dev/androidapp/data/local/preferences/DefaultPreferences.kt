...
class DefaultPreferences @Inject constructor(
    ...
    override fun saveFilterObjects(filterObjects: ProjectFilterDTO) {
        ...
        preferences.edit()
            .putString(
                IPreferences.KEY_FILTER_OBJECTS_EXPECTED_COMPLETION_DATE,
                filterObjects.expectedCompletionDate
            )
            .apply()
        preferences.edit()
            .putString(
                IPreferences.KEY_FILTER_OBJECTS_APPLICATION_DEADLINE,
                filterObjects.applicationDeadline
            )
            .apply()
        preferences.edit()
            .putString(
                IPreferences.KEY_FILTER_OBJECTS_PROFESSION_LEVEL,
                filterObjects.professionLevel
            )
            .apply()
        preferences.edit()
        ...
        preferences.edit()
            .putString(
                IPreferences.KEY_FILTER_OBJECTS_FEEDBACK_TIME_RANGE,
                filterObjects.feedbackTimeRange
            )
            .apply()
        preferences.edit()
    ...
    override fun getFilterObjects(): ProjectFilterDTO {
    ...
    override fun clearFilterObjects() = preferences.edit()
        ...
        .remove(IPreferences.KEY_FILTER_OBJECTS_EXPECTED_COMPLETION_DATE)
        .remove(IPreferences.KEY_FILTER_OBJECTS_APPLICATION_DEADLINE)
        .remove(IPreferences.KEY_FILTER_OBJECTS_PROFESSION_LEVEL)
        .remove(IPreferences.KEY_FILTER_OBJECTS_PROJECT_LEVEL)
        .remove(IPreferences.KEY_FILTER_OBJECTS_DEGREE)
        .remove(IPreferences.KEY_FILTER_OBJECTS_FEEDBACK_TIME_RANGE)
    ...
    override fun clearUserInformation() {
        ...
        preferences.edit()
            ...
            .remove(IPreferences.KEY_LOGIN_DATE)
            .apply()
    }
    ...
    override fun saveLoginDate(now: LocalDate) {
        preferences.edit()
            .putString(
                IPreferences.KEY_LOGIN_DATE,
                DateTimeFormatter.ofPattern(context.getString(R.string.local_date_formatter))
                    .format(now)
            )
            .apply()
    }
    ...
    override fun getLoginDate(): LocalDate {
        ...
        val loginDate = preferences.getString(IPreferences.KEY_LOGIN_DATE, now)
    ...
    private fun getExpectedCompletionDate(): String? {
        return preferences.getString(IPreferences.KEY_FILTER_OBJECTS_EXPECTED_COMPLETION_DATE, "")
    }

    private fun getApplicationDeadline(): String? {
        return preferences.getString(IPreferences.KEY_FILTER_OBJECTS_APPLICATION_DEADLINE, "")
    }

    private fun getProfessionLevel(): String? {
        return preferences.getString(IPreferences.KEY_FILTER_OBJECTS_PROFESSION_LEVEL, "")
    }
    ...
    private fun getFeedbackTimeRange(): String? {
        return preferences.getString(IPreferences.KEY_FILTER_OBJECTS_FEEDBACK_TIME_RANGE, "")
    }
