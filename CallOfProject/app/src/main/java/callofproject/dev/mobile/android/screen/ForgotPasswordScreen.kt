    ...
    Box(contentAlignment = Alignment.Center, modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            OutlinedTextField(value = mEmail, onValueChange = {
                ...
                .fillMaxWidth()
                .padding(bottom = 8.dp), keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Email),
                colors = OutlinedTextFieldDefaults.colors(focusedBorderColor = Color(0xFF295a8c), unfocusedBorderColor = Color.Gray))

            Button(onClick = { sendResetPasswordLink(navController) }, modifier = Modifier.align(Alignment.CenterHorizontally),
...
fun sendResetPasswordLink(navController : NavController)
{
